...
AGENT_EXECUTION_BY_SLUG: dict[str, dict[str, Any]] = {
    ...
    "resume": {
        ...
        "how_to_steps": [
            "رزومه‌ها را در بخش فایل آپلود کنید.",
            "پس از ingest، از پنل ایجنت وضعیت صف را ببینید.",
            "برای غربال با چت از example-worker-chat استفاده کنید.",
        ],
        "inputs": ["PDF یا TXT رزومه"],
        "outputs": ["امتیاز تطابق", "خلاصه نقاط قوت/ضعف"],
        "tips": ["ایجنت فقط دریافت فایل است — تحلیل عمیق در worker-chat."],
    },
    "example-worker-chat": {
        "profile": "resume",
